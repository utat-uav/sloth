...
class CustomPointItem(PointItem):
    def __init__(self, model_item=None, prefix="", parent=None):
        PointItem.__init__(self, model_item, prefix, parent)
        self._radius = 8
        self._point = None
        mypen = QPen()
        mypen.setWidth(4)
...
class LesserSnowGoose(CustomPointItem):
    def __init__(self, model_item=None, prefix="", parent=None):
        CustomPointItem.__init__(self, model_item, prefix, parent)
        self.setColor(Qt.magenta)
        self.updatePoint()
    
class BlueSnowGoose(CustomPointItem):
    def __init__(self, model_item=None, prefix="", parent=None):
        CustomPointItem.__init__(self, model_item, prefix, parent)
        self.setColor(Qt.cyan)
        self.updatePoint()

class CanadaGoose(CustomPointItem):
    def __init__(self, model_item=None, prefix="", parent=None):
        CustomPointItem.__init__(self, model_item, prefix, parent)
